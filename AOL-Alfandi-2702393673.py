...
def calculate_taylor_series(poly_func, months, degree):
    ...
    for i in range(1, degree + 1):
        ...
        taylor_approx += (derivative / np.math.factorial(i)) * (x - a) ** i
...
def main():
    ...
    start_building_month = breach_month - 13
    ...
    print("Month to start building a new warehouse:", start_building_month)
